...
Need add some custom style into one of your post?

Install this plugin now!

This plugin allow you to add custom style to a post by shortcode `[style]` in post's content.

You may also want to use [Add Script To Post](http://wordpress.org/plugins/add-script-to-post/) too!
...
You may post on the [support forum of this plugin](http://wordpress.org/support/plugin/add-style-to-post/) to ask for help.
